...
| latitude | decimal(10,7) | Yes | Vĩ độ (GIS) |
| longitude | decimal(10,7) | Yes | Kinh độ (GIS) |
...
**Ghi chú:** Các cột `ward`, `district`, `city` được tách ra từ `address` để hỗ trợ lọc tòa nhà theo khu vực (UC03).
