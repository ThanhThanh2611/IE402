...
| UC06 | View 3D Building Model | Done | Done | Done | BE lưu/trả `model3dUrl`; FE render bằng React Three Fiber / drei. |
| UC07 | View Floors | Done | Done | Done | BE có floors và dữ liệu GIS tầng; FE hiển thị danh sách tầng, bật/tắt tầng. |
| UC08 | View Apartment Units | Done | Done | Done | BE trả apartments theo tầng; FE hiển thị danh sách căn hộ và popup từ model 3D. |
