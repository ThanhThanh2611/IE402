...
{
  "nodes": [
    { "id": 1, "floor_id": 1, "node_type": "junction", "label": "Sảnh tầng 1", "lng": 106.7004, "lat": 10.7379, "z": 3.5 }
  ],
  "edges": [
    { "id": 1, "start_node_id": 1, "end_node_id": 2, "edge_type": "hallway", "distance": "10.00", "is_accessible": true }
  ]
}
```
